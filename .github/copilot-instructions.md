...
* Add a one-line summary of the actions taken inside each response for task completion. Examples: "Changed the style of the button in the header to be more prominent"; "Fixed header to fit on screen". Separate multiple actions with a semicolon.

...
export const pois = [
    ...
    { position: new THREE.Vector3(-20, 30, 0), color: poiColors[1], name: 'Clarenova', url: '[in progress]', description: 'What started as the financial operations for Sam\'s body of work has become a brand that represents the values of clarity and simplicity in a world of complex technicalities.', timestamp: '2024' },

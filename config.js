...
export const pois = [
    ...
    { position: new THREE.Vector3(40, -80, 0), color: poiColors[3], name: 'WoodLab Demo App', url: 'https://github.com/justsamguy/WL-Configurator-Demo', description: 'What was just another experiment went successful - I\'ll let the app speak for itself.' },
